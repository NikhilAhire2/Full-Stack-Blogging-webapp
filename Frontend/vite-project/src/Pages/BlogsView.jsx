...
const generateBlogSummary = async () => {
  try {
    ...
    const res = await axios.post(
      "https://full-stack-blogging-webapp.onrender.com/api/v1/blog/summary",
      {
        content: plainText
      }
    );
...
const askQuestion = async () => {
  ...
  try {
    ...
    const res = await axios.post(
      "https://full-stack-blogging-webapp.onrender.com/api/v1/blog/ask-blog",
      {
...
const [liked, setLiked] = useState(
  ...
  const likeOrDislikeHandler = async () => {
    try {
      ...
      const res = await axios.get(`https://full-stack-blogging-webapp.onrender.com/api/v1/blog/${selectedBlog?._id}/${action}`, { withCredentials: true })
...
async (language) => {
  ...
  try {
    ...
    const res =
      await axios.post(
        "https://full-stack-blogging-webapp.onrender.com/api/v1/blog/translate",
        {
          blogId:
            selectedBlog._id,
          language
