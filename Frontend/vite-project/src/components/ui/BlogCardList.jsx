...
const BlogCardList = ({ blog }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-700 dark:border-gray-600 flex flex-col md:flex-row md:gap-10 p-5 rounded-2xl mt-6  shadow-lg border hover:scale-105 transition-all pr-65">
      <div>
        <img src={blog.thumbnail} alt='' className='rounded-lg md:w-[300px] ' />
